...
if (!("sigmachat" in chat)) chat.sigmachat = false
...
if (
  ...
  if (m.text && m.text.match(/(sigma|a|ا|م|ي|ء|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y|z)/gi)) {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '😻 𝗦𝗨𝗣𝗘𝗥 𝗦𝗜𝗚𝗠𝗔-𝗠𝗗 😻') :
...
"mediaType": 1, 
sourceUrl: 'https://github.com/SigmaByteXD/SIGMA-MD' }}}, { quoted: fkontak2 })
apii.data = ''
